...
public class BuyItemControl : MonoBehaviour {
    ...
    void Start() {
#if UNITY_PURCHASING
        if (GameManager.Instance != null && GameManager.Instance.IAPControl != null && GameManager.Instance.IAPControl.controller != null) {
            if (this.index == 1) {
...
#else
        if (priceText != null) priceText.GetComponent<Text>().text = "N/A";
#endif
