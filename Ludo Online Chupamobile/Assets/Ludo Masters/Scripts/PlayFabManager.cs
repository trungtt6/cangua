...
public class PlayFabManager : Photon.PunBehaviour, IChatClientListener
{
    ...
    void Awake()
    {
        ...
        // Ensure AutoMatchManager is available on this object to control auto-matching
        if (this.gameObject.GetComponent<AutoMatchManager>() == null)
        {
            this.gameObject.AddComponent<AutoMatchManager>();
        }
    }
