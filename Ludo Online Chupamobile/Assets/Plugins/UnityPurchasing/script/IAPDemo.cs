...
// Demo disabled to avoid compile-time demo surface requirements.
// Kept as a minimal placeholder.
...
#if false
// Guard entire file so demo code doesn't compile when Unity Purchasing package is absent
#if UNITY_PURCHASING
using System;
